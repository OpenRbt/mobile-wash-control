...
part 'model/arg_dispenser_stop.dart';
part 'model/arg_end_session.dart';
...
part 'model/create_session.dart';
part 'model/create_task.dart';
part 'model/create_task_by_hash.dart';
part 'model/delete_user409_response.dart';
part 'model/discount_program.dart';
part 'model/firmware_version.dart';
part 'model/kasse_config.dart';
part 'model/key_pair.dart';
part 'model/load_relay_request.dart';
part 'model/money_report.dart';
part 'model/money_report_creation.dart';
part 'model/pay.dart';
part 'model/pay_received.dart';
...
part 'model/service_status.dart';
part 'model/session.dart';
part 'model/set_build_script.dart';

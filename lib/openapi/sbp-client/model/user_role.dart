...
class UserRole {
  ...
  static const systemManager = UserRole._(r'systemManager');
  static const admin = UserRole._(r'admin');
  static const noAccess = UserRole._(r'noAccess');
...
class UserRoleTypeTransformer {
  ...
  UserRole? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'systemManager': return UserRole.systemManager;
        case r'admin': return UserRole.admin;
        case r'noAccess': return UserRole.noAccess;
        default:
          if (!allowNull) {

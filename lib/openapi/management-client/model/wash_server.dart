...
class WashServer {
  ...
  @override
  String toString() => 'WashServer[id=$id, title=$title, description=$description, serviceKey=$serviceKey, createdBy=$createdBy, isOnline=$isOnline, groupId=$groupId, organizationId=$organizationId, organizationDisplayName=$organizationDisplayName, groupName=$groupName]';

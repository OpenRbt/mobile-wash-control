...
class ArgRunProgram {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgRunProgram && other.hash == hash && other.programID == programID && other.preflight == preflight;

  @override
  int get hashCode => (hash == null ? 0 : hash.hashCode) + (programID == null ? 0 : programID.hashCode) + (preflight == null ? 0 : preflight.hashCode);
  ...
  static List<ArgRunProgram> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgRunProgram>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgRunProgram.listFromJson(
          value,

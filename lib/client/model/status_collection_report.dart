...
class StatusCollectionReport {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is StatusCollectionReport && other.stations == stations;

  @override
  int get hashCode => (stations == null ? 0 : stations.hashCode);
  ...
  static List<StatusCollectionReport> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<StatusCollectionReport>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = StatusCollectionReport.listFromJson(
          value,

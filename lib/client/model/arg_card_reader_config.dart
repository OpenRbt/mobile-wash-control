...
class ArgCardReaderConfig {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgCardReaderConfig && other.stationID == stationID;
  ...
  static List<ArgCardReaderConfig> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgCardReaderConfig>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgCardReaderConfig.listFromJson(
          value,

...
class ArgStationReportCurrentMoney {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgStationReportCurrentMoney && other.id == id;
  ...
  static List<ArgStationReportCurrentMoney> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgStationReportCurrentMoney>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgStationReportCurrentMoney.listFromJson(
          value,

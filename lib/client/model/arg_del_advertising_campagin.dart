...
class ArgDelAdvertisingCampagin {
  ...
  static List<ArgDelAdvertisingCampagin> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <ArgDelAdvertisingCampagin>[]
  ...
  static Map<String, List<ArgDelAdvertisingCampagin>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<ArgDelAdvertisingCampagin>>{};
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgDelAdvertisingCampagin.listFromJson(value, emptyIsNull: emptyIsNull, growable: growable,);
      });
    }
    return map;
  }

...
class InlineResponse409 {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InlineResponse409 &&
     other.code == code &&
  ...
  static List<InlineResponse409> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <InlineResponse409>[]
  ...
  static Map<String, List<InlineResponse409>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<InlineResponse409>>{};
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = InlineResponse409.listFromJson(value, emptyIsNull: emptyIsNull, growable: growable,);
      });
    }
    return map;
  }

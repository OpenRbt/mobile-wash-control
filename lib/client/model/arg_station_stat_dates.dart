...
class ArgStationStatDates {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgStationStatDates && other.stationID == stationID && other.startDate == startDate && other.endDate == endDate;
  ...
  static List<ArgStationStatDates> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgStationStatDates>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgStationStatDates.listFromJson(
          value,

...
class ArgUserPassword {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgUserPassword && other.login == login && other.oldPassword == oldPassword && other.newPassword == newPassword;

  @override
  int get hashCode => (login == null ? 0 : login.hashCode) + (oldPassword == null ? 0 : oldPassword.hashCode) + (newPassword == null ? 0 : newPassword.hashCode);
  ...
  static List<ArgUserPassword> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgUserPassword>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgUserPassword.listFromJson(
          value,

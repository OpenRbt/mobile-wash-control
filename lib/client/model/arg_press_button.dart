...
class ArgPressButton {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgPressButton && other.hash == hash && other.buttonID == buttonID;

  @override
  int get hashCode => (hash == null ? 0 : hash.hashCode) + (buttonID == null ? 0 : buttonID.hashCode);
  ...
  static List<ArgPressButton> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgPressButton>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgPressButton.listFromJson(
          value,

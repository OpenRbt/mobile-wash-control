...
class StationReport {
  ...
  static List<StationReport> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <StationReport>[]
  ...
  static Map<String, List<StationReport>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<StationReport>>{};
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = StationReport.listFromJson(value, emptyIsNull: emptyIsNull, growable: growable,);
      });
    }
    return map;
  }

...
class ArgUserDelete {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgUserDelete && other.login == login;

  @override
  int get hashCode => (login == null ? 0 : login.hashCode);
  ...
  static List<ArgUserDelete> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgUserDelete>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgUserDelete.listFromJson(
          value,

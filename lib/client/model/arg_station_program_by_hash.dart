...
class ArgStationProgramByHash {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgStationProgramByHash && other.hash == hash;
  ...
  static List<ArgStationProgramByHash> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgStationProgramByHash>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgStationProgramByHash.listFromJson(
          value,

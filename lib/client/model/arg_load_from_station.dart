...
class ArgLoadFromStation {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgLoadFromStation && other.hash == hash && other.stationID == stationID && other.key == key;

  @override
  int get hashCode => (hash == null ? 0 : hash.hashCode) + (stationID == null ? 0 : stationID.hashCode) + (key == null ? 0 : key.hashCode);
  ...
  static List<ArgLoadFromStation> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgLoadFromStation>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgLoadFromStation.listFromJson(
          value,

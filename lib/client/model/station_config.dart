...
class StationConfig {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is StationConfig && other.id == id && other.preflightSec == preflightSec && other.name == name && other.hash == hash && other.relayBoard == relayBoard;

  @override
  int get hashCode => (id == null ? 0 : id.hashCode) + (preflightSec == null ? 0 : preflightSec.hashCode) + (name == null ? 0 : name.hashCode) + (hash == null ? 0 : hash.hashCode) + (relayBoard == null ? 0 : relayBoard.hashCode);
  ...
  static List<StationConfig> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<StationConfig>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = StationConfig.listFromJson(
          value,

...
class ArgSetStationButton {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgSetStationButton && other.stationID == stationID && other.buttons == buttons;

  @override
  int get hashCode => (stationID == null ? 0 : stationID.hashCode) + (buttons == null ? 0 : buttons.hashCode);
  ...
  static List<ArgSetStationButton> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgSetStationButton>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgSetStationButton.listFromJson(
          value,

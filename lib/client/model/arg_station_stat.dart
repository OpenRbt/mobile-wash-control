...
class ArgStationStat {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgStationStat && other.stationID == stationID;
  ...
  static List<ArgStationStat> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgStationStat>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgStationStat.listFromJson(
          value,

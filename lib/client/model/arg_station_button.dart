...
class ArgStationButton {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgStationButton && other.stationID == stationID;
  ...
  static List<ArgStationButton> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgStationButton>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgStationButton.listFromJson(
          value,

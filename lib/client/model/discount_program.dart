...
class DiscountProgram {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DiscountProgram && other.programID == programID && other.discount == discount;

  @override
  int get hashCode => (programID == null ? 0 : programID.hashCode) + (discount == null ? 0 : discount.hashCode);
  ...
  static List<DiscountProgram> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<DiscountProgram>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = DiscountProgram.listFromJson(
          value,

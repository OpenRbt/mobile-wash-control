...
class ResponseStationCollectionReportDates {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ResponseStationCollectionReportDates && other.collectionReports == collectionReports;

  @override
  int get hashCode => (collectionReports == null ? 0 : collectionReports.hashCode);
  ...
  static List<ResponseStationCollectionReportDates> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ResponseStationCollectionReportDates>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ResponseStationCollectionReportDates.listFromJson(
          value,

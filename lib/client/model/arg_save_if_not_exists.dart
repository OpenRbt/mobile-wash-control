...
class ArgSaveIfNotExists {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgSaveIfNotExists && other.hash == hash && other.keyPair == keyPair;
  ...
  static List<ArgSaveIfNotExists> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgSaveIfNotExists>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgSaveIfNotExists.listFromJson(
          value,

...
class ArgAdvertisingCampagin {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgAdvertisingCampagin && other.startDate == startDate && other.endDate == endDate;

  @override
  int get hashCode => (startDate == null ? 0 : startDate.hashCode) + (endDate == null ? 0 : endDate.hashCode);
  ...
  static List<ArgAdvertisingCampagin> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgAdvertisingCampagin>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgAdvertisingCampagin.listFromJson(
          value,

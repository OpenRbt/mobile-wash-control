...
class ResponseUserPassword {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ResponseUserPassword && other.id == id;
  ...
  static List<ResponseUserPassword> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ResponseUserPassword>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ResponseUserPassword.listFromJson(
          value,

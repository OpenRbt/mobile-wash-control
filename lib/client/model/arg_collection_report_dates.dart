...
class ArgCollectionReportDates {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgCollectionReportDates && other.stationID == stationID && other.startDate == startDate && other.endDate == endDate;

  @override
  int get hashCode => (stationID == null ? 0 : stationID.hashCode) + (startDate == null ? 0 : startDate.hashCode) + (endDate == null ? 0 : endDate.hashCode);
  ...
  static List<ArgCollectionReportDates> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgCollectionReportDates>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgCollectionReportDates.listFromJson(
          value,

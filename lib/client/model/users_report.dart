...
class UsersReport {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UsersReport && other.users == users;
  ...
  static List<UsersReport> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<UsersReport>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = UsersReport.listFromJson(
          value,

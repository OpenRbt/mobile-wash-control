...
class ArgDelStation {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgDelStation && other.id == id;
  ...
  static List<ArgDelStation> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgDelStation>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgDelStation.listFromJson(
          value,

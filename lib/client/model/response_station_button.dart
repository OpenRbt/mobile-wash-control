...
class ResponseStationButton {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ResponseStationButton && other.buttons == buttons;

  @override
  int get hashCode => (buttons == null ? 0 : buttons.hashCode);
  ...
  static List<ResponseStationButton> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ResponseStationButton>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ResponseStationButton.listFromJson(
          value,

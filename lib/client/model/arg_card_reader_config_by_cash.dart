...
class ArgCardReaderConfigByCash {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgCardReaderConfigByCash && other.hash == hash;
  ...
  static List<ArgCardReaderConfigByCash> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgCardReaderConfigByCash>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgCardReaderConfigByCash.listFromJson(
          value,

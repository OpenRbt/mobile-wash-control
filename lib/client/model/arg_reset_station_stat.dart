...
class ArgResetStationStat {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ArgResetStationStat && other.stationID == stationID;
  ...
  static List<ArgResetStationStat> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgResetStationStat>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgResetStationStat.listFromJson(
          value,

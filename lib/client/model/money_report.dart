...
class MoneyReport {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is MoneyReport && other.carsTotal == carsTotal && other.coins == coins && other.banknotes == banknotes && other.electronical == electronical && other.service == service && other.hash == hash;
  ...
  static List<MoneyReport> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<MoneyReport>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = MoneyReport.listFromJson(
          value,

...
class ArgUserUpdate {
  ...
  bool operator ==(Object other) =>
      ...
      other is ArgUserUpdate && other.login == login && other.firstName == firstName && other.middleName == middleName && other.lastName == lastName && other.isAdmin == isAdmin && other.isOperator == isOperator && other.isEngineer == isEngineer;
  ...
  static List<ArgUserUpdate> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<ArgUserUpdate>> mapListFromJson(
    ...
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = ArgUserUpdate.listFromJson(
          value,

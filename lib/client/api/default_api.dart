...
class DefaultApi {
  ...
  ///
  /// 
  Future<String> loadFromStation(Object args) async {
    Object postBody = args;
    ...
    // create path and map variables
    String path = "/load-from-station".replaceAll("{format}","json");
  ...
  ///
  /// 
  Future<MoneyReport> loadMoney(Object args) async {
    Object postBody = args;
  ...
  ///
  /// 
  Future pressButton(Object args) async {
    Object postBody = args;
    ...
    // create path and map variables
    String path = "/press-button".replaceAll("{format}","json");
  ...
  ///
  /// 
  Future saveStationEvent(Object args) async {
    Object postBody = args;
    ...
    // create path and map variables
    String path = "/save-station-event".replaceAll("{format}","json");
  ...
  ///
  /// 
  Future<StationEventReport> stationEventsByDate(StationEventsByDateArgs args) async {
    Object postBody = args;
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'StationEventReport') as StationEventReport ;
    } else {
      return null;
    }
  }

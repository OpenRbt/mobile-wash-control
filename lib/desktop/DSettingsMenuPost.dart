...
class DSettingsMenuPost extends StatefulWidget {
  @override
  _DSettingsMenuPostState createState() => _DSettingsMenuPostState();
}

class DSettingsMenuPostArgs {
  final int stationID;
  final String stationIP;
  final SessionData sessionData;
  final List<String> availableHashes;

  DSettingsMenuPostArgs(this.stationID, this.stationIP, this.availableHashes, this.sessionData);
}

class _DSettingsMenuPostState extends State<DSettingsMenuPost> {
  final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();
  var _isSnackBarActive = ValueWrapper(false);

  final int _maxButtons = 20;
  _DSettingsMenuPostState() : super();
  ...
  void _getPost(DSettingsMenuPostArgs settingsMenuPostArgs) async {
    try {
      var args = ArgStation(
  ...
  void _savePost(DSettingsMenuPostArgs settingsMenuPostArgs, BuildContext context) async {
    try {
  ...
  void _getCardReader(DSettingsMenuPostArgs settingsMenuPostArgs) async {
    try {
  ...
  void _saveCardReader(DSettingsMenuPostArgs settingsMenuPostArgs, BuildContext context) async {
    try {
  ...
  void _getButtons(DSettingsMenuPostArgs settingsMenuPostArgs) async {
    try {
    ...
    try {
      var args = ArgStationButton(stationID: settingsMenuPostArgs.stationID);
  ...
  void _saveButtons(DSettingsMenuPostArgs settingsMenuPostArgs, BuildContext context) async {
    try {
  ...
  Widget build(BuildContext context) {
    ...
    DSettingsMenuPostArgs settingsMenuPostArgs = ModalRoute.of(context).settings.arguments;

  ...
  Future<Null> _selectEndDate(BuildContext context) async {
    {
      ...
      setState(() {
        if (picked != null && picked != _endDate) {
          _endDate = picked;
          _endDate = _endDate.add(Duration(days: 1, seconds: -1));
                  ...
                  child: Padding(
                      ...
                      child: ListView(children: [
                          ...
                          children: [
                            ...
                            IconButton(
                                icon: Icon(
                                  Icons.update,
                                  color:
                                      _updating ? Colors.yellow : Colors.green,
                                ),
                                onPressed: () {
                                  _GetStatistics(sessionData);
                                  setState(() {});
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text("Вывод: ", style: TextStyle(fontSize: 16)),
                            SizedBox(
                              width: screenW / 3 * 2,
                              child: DropdownButton(
                                  ...
                                  items: [
                                    ...
                                    DropdownMenuItem(
                                        value: true, child: Text("По датам"))
                                  ],
                                  onChanged: (newValue) {
                                    _byDate = newValue;
                                    setState(() {});
